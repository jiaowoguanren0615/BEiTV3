...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'BEiT3 training and evaluation script', add_help=False)
    ...
    # Finetuning params
    parser.add_argument('--finetune', default='./beit3_base_patch16_224_in1k.pth',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'BEiT3 training and evaluation script', parents=[get_args_parser()])
