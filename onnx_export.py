...
parser.add_argument('--model', default='beit3_base_patch16_224_imageclassification', type=str, metavar='MODEL',
                        choices=['beit3_base_patch16_224_imageclassification',
                                 'beit3_giant_patch14_224_imageclassification',
                                 'beit3_large_patch16_224_imageclassification'
                                 ],
                    help='model architecture (default: beit3_base_patch16_224_imageclassification)')
parser.add_argument('--checkpoint', default='./output/beit3_base_patch16_224_imageclassification_best_checkpoint.pth', type=str, metavar='PATH',
